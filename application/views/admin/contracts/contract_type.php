            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php echo render_textarea('details','','',array(),array(),'','tinymce'); ?>
                        <span>{customer}, {customer_address}, {agent}, {agent_address}, {contract_value}</span>
                    </div>
                </div>
            </div>
...
function getAllValues(id){
    var data = (function get_php_data() {
        var php_data;
        $.ajax({
