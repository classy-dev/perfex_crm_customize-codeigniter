         ...
         <div class="col-md-5 left-column" id="left-column">
            <div class="panel_s">
               <div class="panel-body">
                  <!-- check box -->
                  <?php echo form_open(admin_url('contracts/contract_import'),array('id'=>'contract-form')); ?>
                  ...
                  <input type="hidden" name="imported_contract" id="imported_contract" value="">
                  <!-- subject -->
      ...
      $('#contract-attachments-form').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(dt){
              ...
              $('#pdf_viewer').empty();
              $('#pdf_viewer').append(data.embed);
              $('#imported_contract').val(data.path);
            }
        });
