				...
				<div class="panel_s">
					<div class="panel-body">
						<?php if(has_permission('staff','','create')){ ?>
						 <!-- <div class="_buttons">
							<a href="<?php echo admin_url('staff/user_relation'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new_staff'); ?></a>
						</div> --> 
						...
						render_datatable($table_data,'user_relation');
						?>
					</div>
				</div>
			</div>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<!-- <?php
				echo render_select('transfer_data_to',$user_relation,array('staffid',array('firstname','lastname')),'staff_member',get_staff_user_id(),array(),array(),'','',false);
				?> -->
			</div>
...
<script>
	$(function(){
		initDataTable('.table-user_relation', window.location.href);
	});
