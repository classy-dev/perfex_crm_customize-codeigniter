                    ...
                    <div class="row" id="contract_summary">
                        ...
                        <div class="col-md-2 col-xs-6 border-right">
                            <h3 class="bold">
                                ...
                                <?php echo total_rows(db_prefix().'contracts',array_merge(array('DATE(dateend) <'=>date('Y-m-d'),'trash'=>0),$where_own['addedfrom'])); ?>
                        ...
                        <div class="col-md-2 col-xs-6 border-right">
                            <h3 class="bold">
                                <?php 
                                    ...
                                    for ($i=0; $i < count($where_own['addedfrom']) ; $i++) { 
                                      $count += total_rows(
                                        db_prefix().'contracts','dateend BETWEEN "'.$minus_7_days.'" AND "'.$plus_7_days.'" AND trash=0 AND dateend is NOT NULL AND dateend >"'.date('Y-m-d').'"' . (count($where_own['addedfrom']) > 0 ? ' AND addedfrom='. $where_own['addedfrom'][$i] : ''));
                                    }
                                    echo $count;
                                ?>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <h3 class="bold"><?php echo total_rows(db_prefix().'contracts',array_merge(array('trash'=>1),$where_own['addedfrom'])); ?></h3>
