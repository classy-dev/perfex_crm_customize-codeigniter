<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
		...
		<div class="col-lg-6 no-padding" style="padding-left:0px; padding-right:0px; height: 100vh;">
			<div class="form-content content-colored">
				<div class="form-title title-white"></div>
