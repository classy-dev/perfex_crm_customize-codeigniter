...
<body class="login_admin"<?php if(is_rtl()){ echo ' dir="rtl"'; } ?>   style="background-image: url(<?php echo site_url('/assets/images/1493.png') ?>); background-repeat: no-repeat; background-size: 100%,100%;">
 <div class="container">
