...
<body class="login_admin"<?php if(is_rtl()){ echo ' dir="rtl"'; } ?>   style="background-image: url(<?php echo site_url('/assets/images/1.png') ?>); background-repeat: no-repeat; background-size: 100%,100%;">
 <div class="container">
  <div class="row" style="display: flex;">
    <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper" style="margin-left: 0;padding-right: 0;margin-top: 170px;">
      <img src="<?php echo site_url('/assets/images/1.png') ?>" style="width: 100%; height: 100%;">
    </div>
    <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper" style="margin-left: 0; padding-left: 0; margin-top: 170px;">
      <div class="company-logo" style="background: white; padding-bottom: 0;padding-top: 50px;">
        <?php get_company_logo(); ?>
      </div>
      <div class="mtop40 authentication-form" style="border:0;">
