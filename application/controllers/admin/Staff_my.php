...
//     }
    ...
    {
        echo "Here is stripe Bank Detail Function"; exit();
        ...
        $data = [];
            ...
            if(!empty($image)){
                //if($size > 50000000){
                     ...
                     if($isUploaded){
                        // print_r(site_url('uploads/document_details/'.$newImageName)); exit();
                          ...
                          // $id_proof_file_front_id = $this->stripe_core->create_file_id(fopen(site_url('uploads/document_details/'.$newImageName), 'r'));
