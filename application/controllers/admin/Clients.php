...
class Clients extends AdminController
{
    ...
    public function index()
    {
        ...
        if (!has_permission('customers', '', 'view')) {
            ...
            if (isset($res)) $whereIn = implode(",", $res);
            $where_include = ' AND userid IN (SELECT customer_id FROM '.db_prefix().'customer_admins WHERE staff_id IN (' . $whereIn . '))';
        }
        $data['where_include'] = $where_include;
    ...
    public function table()
    {
        ...
        // if (!has_permission('customers', '', 'view') or !has_permission('customers', '', 'view_own')) {
        //     // if (!have_assigned_customers() && !has_permission('customers', '', 'create')) {
        //         ajax_access_denied();
        //     // }
        // }

        // if (has_permission( 'customers', '', 'view_own') and !is_admin()){
        ...
        elseif (has_permission('customers', '', 'view'))
        {
